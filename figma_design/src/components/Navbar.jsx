...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full flex justify-between items-center p-4 z-10 backdrop-blur-md style={{ background: 'radial-gradient(circle at 50% 50%, rgba(158, 110, 230, 0.22), rgba(158, 110, 230, 0))' }}">
      <div className="flex items-center justify-start gap-40">
        <div className="text-2xl font-bold tracking-[8px] ml-8">AI.GEN</div>
